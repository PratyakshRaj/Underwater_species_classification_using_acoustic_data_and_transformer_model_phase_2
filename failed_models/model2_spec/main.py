...
# dataset = AudioFeatureDataset("features/spectrogram", label_map_aug)
...
#         train_ins = trainer("features/spectrogram","label_map_aug.json",128,25,fold+1,train_subset=train_subset, val_subset=val_subset)
...
# train_full_ins=trainer("features/spectrogram","label_map_aug.json",128,25,0,train_subset=None,val_subset=None)
...
train_dataset = AudioFeatureDataset("features/spectrogram", label_map_aug)
test_dataset = AudioFeatureDataset("features/test_spectrogram", label_map_aug)

for x, y in [(2,2),(4,2),(4,4),(8,4)]: 
    train_ins=trainer("features/spectrogram","label_map_aug.json",128,128,25,n_heads=x,n_layers=y,fold=0,train_subset=train_dataset,val_subset=test_dataset)
